...
public class Gamen9Servlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			...
			PreparedStatement pstmt = con.prepareStatement("SELECT　PRO.proname as pname, REPO.repo_date as repodate　,  USERX.user_name as uname ,TASK.task_name as tname FROM PRO　JOIN　REPO "
					+ "on PRO.pro_id  = REPO.pro_idJOIN PROMEN "
					+ "on PRO.pro_id　= PROMEN.pro_id JOIN TASK"
					+ "on PRO.pro_id　= TASK.pro_id JOIN USERX "
					+ "on PROMEN.user_id　=USERX.user_id "
